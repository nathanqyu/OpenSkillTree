  ...
  return (
    <section className="py-20">
      ...
      <p className="mt-4 max-w-lg text-sm leading-relaxed text-zinc-500 dark:text-zinc-400">
        Discover what you might be great at, browse the skill maps, or contribute a tree for a
        domain you know well. The library grows with the community that builds it.
      </p>
